...
- **KPI Cards** — live metrics for energy generated, grid usage, CO₂ saved, and cost savings
- **Hourly Chart** — generation vs consumption vs grid export across the day
- **Battery Monitor** — animated storage level with charge rate, runtime estimate, and temperature
- **Energy Flow** — real-time breakdown of power sources and sinks
- **System Log** — timestamped record of system events and alerts
- **Home / Business Toggle** — switches all data between residential and commercial views
...
- HTML5
- CSS3 (CSS Grid, custom properties, keyframe animations)
- Vanilla JavaScript (ES6)
- [Chart.js](https://www.chartjs.org/) — for the hourly line chart
- [Google Fonts](https://fonts.google.com/) — Syne, DM Mono, Inter
